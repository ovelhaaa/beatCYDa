...
# Remove the duplicated/old structs
old_structs = """/* Generic rectangle with hit-test */
struct Rect {
    int16_t x, y, w, h;
...
content = content.replace(old_structs, "")

# remove remaining missing layout vars needed for compilation
content = content.replace("""static const Rect R_SLOT_DEC  = {80,   8,  20,  30};
static const Rect R_SLOT_VAL  = {104,  8,  28,  30};
static const Rect R_SLOT_INC  = {136,  8,  20,  30};""", "")
